...
![ex-gravity](/autox-img/ex-gravity.png)
...
![ex-layout-gravity](/autox-img/ex-layout-gravity.png)
...
![ex1-margin](/autox-img/ex1-margin.png)

如果把`margin="30"`改成`margin="10 40"`那么第一个按钮的左右间距为10dp, 上下间距为40dp, 效果如图:

![ex2-margin](/autox-img/ex2-margin.png)
...
![ex-marginLeft](/autox-img/ex-marginLeft.png)
...
![ex-padding](/autox-img/ex-padding.png)
